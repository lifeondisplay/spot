declare class Spot {
    public static Player: {
        /**
         * registra um ouvinte `type` no spot.player
         *
         * por padrão, `spot.player`sempre despacha:
         *  - `songchange` quando o player muda de faixa
         *  - `onplaypause` quando o jogador reproduz ou pausa
         *  - `onprogress` quando monitorar alterações no progresso
         *  - `appchange` quando o usuário muda de página
         */
        addEventListener(type: string, callback: (event?: Event) => void): void;
        addEventListener(type: "songchange", callback: (event?: Event) => void): void;
        addEventListener(type: "onplaypause", callback: (event?: Event) => void): void;
        addEventListener(type: "onprogress", callback: (event?: Event | { data: number }) => void): void;
        addEventListener(type: "appchange", callback: (event?: Event & {
            data: {
                /**
                 * id do app
                 */
                ...
                /**
                 * se o aplicativo é um elemento incorporado ou um iframe
                 */
                isEmbeddedApp: true;

                /**
                 * elemento html do contêiner de aplicativo ou elemento iframe
                 */
        ...
        /**
         * um objeto contém todas as informações sobre a faixa e o player atuais
         */
        data: any;
        ...
        /**
         * despacha um evento em `spot.player`
         *
         * por padrão, `spot.player` sempre despacha:
        ...
        /**
         * converte os milissegundos para o formato `mm:ss`
         * @param milisecond
         */
        formatTime(milisecond: number): string;

        /**
         * retorna a duração total da música em milissegundos
         */
        getDuration(): number;

        /**
         * retorna o estado de mute
         */
        getMute(): boolean;
        ...
        /**
         * retorna o estado de coração da música
         */
        getHeart(): boolean;

        /**
         * retorna o nível de volume atual (de 0 a 1)
         */
        getVolume(): number;

        /**
         * aumenta uma pequena quantidade de volume
         */
        increaseVolume(): void;

        /**
         * retorna um booleano se o player estiver tocando
         */
        isPlaying(): boolean;
         ...
         */
        skipBack(amount = 15000): void;
        /**
         * Seek to previous `amount` of milisecond
         * @param amount in milisecond. Default: 15000.
         */
        skipForward(amount = 15000): void;
        /**
     ...
     */
    public static addToQueue: (uri: string | string[]) => Promise<void, any>;
     ...
     */
    public static getAblumArtColors: (uri?: string) => Promise<{
        DESATURATED: string;
     ...
     * or specify another track uri.
     */
    public static getAudioData: (uri?: string) => Promise<any>;
    /**
     ...
     */
    public static LibURI: typeof URI;
     ...
     */
    public static removeFromQueue: (uri: string | string[]) => Promise<void, any>;
    /**
...
class URI {
    ...
    */
     ...
     *
     * @param id o id do concert
     * @return o uri do concert
     */
